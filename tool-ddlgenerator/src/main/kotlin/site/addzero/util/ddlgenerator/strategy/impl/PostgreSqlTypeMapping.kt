 ...
 * PostgreSQL 类型映射器
 */
object PostgreSqlTypeMapping : DatabaseTypeMapping {
    ...
    override fun toJdbcType(nativeTypeName: String): Int? {
        ...
        return when {
            ...
            upper.startsWith("CHAR(") || upper.startsWith("CHARACTER(") || upper == "CHAR" || upper == "BPCHAR" -> Types.CHAR
            ...
            upper == "JSON" || upper == "JSONB" -> Types.SQLXML
            upper == "UUID" -> Types.SQLXML
            upper == "INET" || upper == "MACADDR" || upper == "INTERVAL" -> Types.SQLXML
            else -> null
        }
    }
}
